...
We will not provide any example code to facilitate this exercise, you must create this code from scratch, possibly using some of the example code provided in the <debugHL>[Introductory Exercises](../IntroMaterial/IntroExercises.md#buttCode)</debugHL> or the built-in examples as inspiration.
